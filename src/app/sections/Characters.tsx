...
export default function Characters() {
  return (
    <div className=' w-full h-auto relative -translate-y-[150px] md:-translate-y-[300px]'>
        ...
        <h2 className="text-center text-3xl font-bold">Cute Characters</h2>
        ...
        <div className=" flex flex-wrap justify-center gap-4">
          {dogs.map((i) => (
            ...
            <div  key={i} className=' group relative w-[280px] h-[350px] p-8'
            style={{backgroundImage: "url(/assets/card.png)", backgroundSize:'cover', backgroundRepeat:'no-repeat'}}
            >

                <p className=' text-sm mt-4'>Meet</p>
                <h2 className=' text-2xl group-hover:text-orange-200 transition-colors duration-300 font-semibold text-orange-100'>Mochi</h2>
                ...
                <img  src={i} width={220} height={220} className=' group-hover:scale-110 transition-all duration-300 absolute bottom-0 right-0 translate-y-6'/>
